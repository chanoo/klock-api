...
data class SignUpReqDTO(val username: String, val providerUserId: String, val provider: SocialProvider, val email: String?, val password: String?)
data class SignUpResDTO(val username: String, val providerUserId: String, val provider: SocialProvider, val email: String?)
