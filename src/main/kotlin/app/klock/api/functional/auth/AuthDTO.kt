...
data class SignUpReqDTO(val nickName: String, val providerUserId: String, val provider: SocialProvider, val email: String?, val password: String?, val tagId: Long?)
data class SignUpResDTO(val id: Long, val accessToken: String, val refreshToken: String, val nickName: String, val providerUserId: String, val provider: SocialProvider, val email: String?, val tagId: Long?)
