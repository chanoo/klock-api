package app.klock.api.functional.user.dto
...
data class CreateUserRequest(val password: String, override val name: String, override val email: String) : BaseUserDto(name, email)
