...
import app.klock.api.functional.userTrace.UpdateHeartTrace
...
class UserTraceService(
    ...
    fun createContentWithImage(userId: Long, userTrace: CreateContentTrace, imageBytes: ByteArray?, originFileName: String?): Mono<UserTraceDto> {
